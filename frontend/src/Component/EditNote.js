      ...
      >
        <div className="modal-dialog" role="document">
          <div
            ...
            style={{
              backgroundColor: mode === "light" ? "#eef2e4" : "#32383e",
            }}
          >
            <div className="modal-header">
              <div>
                <h5
                  className="modal-title fontMain"
                ...
                >
                  Your Note
                  <i
                    className="mx-2 fas fa-file-download"
                    title="Download Note"
                  ></i>
                </h5>
              ...
              <button
                className={`btn btn-outline-info mx-3 me-2 ${
                  !note.share ? "d-none" : ""
                }`}
                title={"Copy Link"}
                onClick={CopyToClipBoard}
              >
                <i className="far fa-copy mx-2 my-2"></i>
              </button>
              <Link
                to={`/mynote/${note._id}`}
                onClick={() => {
              ...
              >
                <i className="fas fa-angle-right mx-3 me-2"></i>
              </Link>

              <button
                type="button"
                className={`btn-close ${mode === "light" ? "" : "bg-light"}`}
                data-dismiss="modal"
                aria-label="Close"
              ></button>
            </div>
