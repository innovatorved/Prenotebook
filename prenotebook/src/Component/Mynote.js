                ...
                <div className="card" style={{ "backgroundColor": mode === "light" ? "" : "#667574", "borderColor": mode === "light" ? "gray" : "#dee4ce" }}>
                    <div className="card-body">
                        ...
                        <div className="list-inline">
                            <h5 className="list-inline-item card-title text-center fontMain" style={{ "color": mode === "light" ? "" : "white" }}>{mynote.title}</h5>
                            <button type="button" className="list-inline-item mx-2 btn btn-outline-primary" title={`${playing !== true ? "Play Note" : "Stop Playing"}`} ><i className={`fas fa-${playing === true ? "pause" : "play"}`} onClick={() => speak(mynote)} ></i></button>
                        </div>
