...
export default function AddNote() {
    ...
    return (
        <div className="container my-3">
            <h2 className="fontMain" style={{"color" : mode==="light"?"":"#dee4ce"}}>Create a Note</h2>
            <form className="my-3">
                <div className="form-group my-2">
                    <label htmlFor="title" style={{"color" : mode==="light"?"":"#dee4ce"}}>Title</label>
                    <input type="text" style={{"backgroundColor" : mode==="light"?"":"#667574" ,"color" : mode==="light"?"":"white"}} className="form-control" id="title" name="title" value={note.title}  placeholder="Title" onChange={ChangesInNote}/>
                </div>
                <div className="form-group my-2">
                    <label htmlFor="description" style={{"color" : mode==="light"?"":"#dee4ce"}}>Description</label>
                    <textarea type="text" style={{"backgroundColor" : mode==="light"?"":"#667574" , "color" : mode==="light"?"":"white"}} className="form-control" id="description"  name="description" value={note.description} placeholder="Description" onChange={ChangesInNote}></textarea>
                </div>
                <div className="form-group my-2">
