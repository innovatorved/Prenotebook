...
export default function HomePage() {
  ...
  const note = {
    ...
    title: "Hello Users !",
    description:
      "This is a simple note that demonstrate the usage of prenotebook.Notebook is a note-taking service included as part of the free, web-based Notebook Editors . Notebook is available as a web application for desktop and mobile versions.",
  };
  return (
    <div>
      <div className="row">
